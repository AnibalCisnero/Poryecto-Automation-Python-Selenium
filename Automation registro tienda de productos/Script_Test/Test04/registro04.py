#Caso de Prueba: Probar el registro con un nombre de usuario ya existente y comprobar que se muestra una notificación de nombre de usuario en uso.
import unittest
...
if __name__ == '__main__':
    ...
    archivo_salida = open('reporte Formulario de Registro (04).html', 'w')
