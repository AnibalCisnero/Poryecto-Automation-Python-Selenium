#Caso de Prueba: Probar el registro con una contraseña ya existente y comprobar que se muestra una notificación de contraseña en uso.
import unittest
...
if __name__ == '__main__':
    ...
    archivo_salida = open('reporte Formulario de Registro (05).html', 'w')
