#En este script probamos como reacciona el sistema si intentamos iniciar sesion sin ingresar una contraseña
import unittest
...
if __name__ == '__main__':
    ...
    archivo_salida = open('Reporte del caso de prueba (Incio de sesion 04).html', 'w')
